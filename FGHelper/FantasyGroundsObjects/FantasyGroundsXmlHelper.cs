...
[assembly:InternalsVisibleTo("FGHelper.Tests")]

namespace FGHelper.FantasyGroundsObjects
{
    /// <summary>
    /// Class for parsing project details into the Fantasy Grounds XML format
    /// </summary>
    public class FantasyGroundsXmlHelper
    {
        ...
        /// <summary>
        /// Generates the definition xml document.  This doc hold the module details such as name and author.
        /// </summary>
        ...
        /// <summary>
        /// Generates the database xml document.  This doc holds the module data. 
        /// </summary>
        ...
        internal XElement GenerateLibrary(string fileName, string projName, string category, List<string> entires )
        {
        ...
        internal XElement GenerateEntry(string projName, string type, string typeName)
        {
        ...
        internal XElement AddLists(Project project)
        {
        ...
        internal XElement GenerateList(string type, string name, string projName, List<IFantasyGroundsObject> fgObjs)
        {
            var result = new XElement(type);
        ...
        internal XElement GenerateListLink(int id, string projName, string className, string linkName)
        {
        ...
        internal XElement AddStoryTemplates(List<IFantasyGroundsObject> storyTemplates)
        {      
        ...
        internal XElement GenerateStoryTemplate(int id, StoryTemplate storyTemplate)
        {
        ...
        internal XElement AddTables(List<IFantasyGroundsObject> tables)
        {
            var categorized = new Dictionary<string, List<XElement>>();
        ...
        internal  XElement GenerateTableEntry(int id, Table table)
        {
            var result = new XElement($"id-{id:D5}");
        ...
        internal XElement GenerateTableRow(int id, List<string> rowValues)
        {
        ...
        internal XElement GenerateRowColumn(int id, string value)
        {
        ...
        internal XElement CategorizeFgElements(string type, Dictionary<string, List<XElement>> categorized)
        {
            var result = new XElement(type);
